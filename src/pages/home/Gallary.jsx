...
const Gallary = () => {
  return (
    <div>
      <div className="text-center mt-20 mb-12 lg:px-0 px-5">
        <h2 className="text-3xl lg:text-4xl font-bold  bg-gradient-to-r from-cyan-500 to-blue-500 text-transparent bg-clip-text">
          A Visual Adventure into the World of Toys!
        </h2>

        <div className="w-full">
          <p className="text-gray-500 text-sm lg:w-1/2 mx-auto mt-3">
      ...
      <div className="border-r-0 border-l-0 border-t-2 border-b-2 p-3 border-blue-500 px-5 lg:p-3 mb-20 ">
        ...
        {/* <div className="flex flex-col gap-3 lg:hidden">
          <img
            src={img2}
            className="h-[250px] w-[400px] rounded-md border-2 px-2"
            alt=""
          />
          <img
            src={img3}
